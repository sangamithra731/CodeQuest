...
const skillTracks = [
  {
    ...
    summary:
      "You're the person who physically goes to a client site — bank branch, retail store, office, telecom tower — to fix network issues, install hardware, maintain servers, or support end-users. It's hands-on, not coding-heavy.",
    skills: [
      {
        title: "Networking (the backbone of this job)",
        points: [
          "OSI Model (7 layers) — Physical, Data Link, Network, Transport, Session, Presentation, Application. Asked in almost every interview.",
          "TCP/IP model — how data actually travels practically.",
          "IP addressing & Subnetting — Classes A/B/C, subnet masks, CIDR notation. Must be able to calculate subnets manually.",
          "DHCP — how a device gets an IP automatically.",
          "DNS — how domain names resolve to IPs.",
          "Routing & Switching basics — static vs dynamic routing, VLAN concept, switch vs hub vs router differences.",
          "Wi-Fi/Wireless — access point configuration, signal troubleshooting.",
          "How deep to go: CCNA syllabus level — working knowledge to troubleshoot, not network-architect depth.",
        ],
      },
      {
        ...
        points: [
          ...
          "Diagnosing BSOD (Blue Screen), POST errors, boot failures.",
          "Printer/scanner/POS machine troubleshooting — extremely common, many field roles are literally 'fix the branch printer.'",
          "Server hardware basics — RAID configurations, hot-swappable drives.",
          "CCTV, biometric attendance devices (common at banks/retail).",
        ],
      },
      {
      ...
      },
      {
        ...
        points: [
          ...
          "SLA (Service Level Agreement) — how fast you must resolve issues.",
          "Asked heavily because field engineers work inside a structured support process.",
        ],
      },
      {
        title: "Soft Skills (heavily weighted here, unlike coding roles)",
        points: [
          "Client communication — you're often the only technical person a non-technical client sees.",
          "Documentation — writing clear call logs and RCA reports.",
          "Time management across multiple site visits.",
          "Willingness to travel/shift work — interviewers ask this directly, be honest.",
        ],
      },
    ],
    certifications: [
      ...
      "CompTIA Network+ — networking fundamentals, slightly broader than CCNA basics.",
    ...
    skills: [
      ...
      },
      {
        ...
        points: [
          ...
          "Computer Networks — TCP/IP, HTTP/HTTPS, DNS (asked more theoretically here).",
        ],
      },
      {
